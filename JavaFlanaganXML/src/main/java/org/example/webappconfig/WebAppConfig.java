...
package org.example.webappconfig;

import javax.xml.parsers.*;   // JAXP classes for parsing

import org.example.xmldocumentwriter.XMLDocumentWriter;  // ащк цкшештп куыгдеы
...
//        WebAppConfig config = new WebAppConfig(new File(args[0]));
        WebAppConfig config = new WebAppConfig(new File("./JavaFlanaganXML/src/main/resources/" + args[0]));
