package org.example.listservlets1;
...
//        spf.setValidating(true);  // No validation required
...
//        org.xml.sax.InputSource input=new InputSource(new FileReader(args[0]));
        org.xml.sax.InputSource input=new InputSource(new FileReader("./JavaFlanaganXML/src/main/resources/" + args[0]));
