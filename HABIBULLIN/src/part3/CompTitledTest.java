...
public class CompTitledTest extends JFrame implements BorderConstants {
	...
	public CompTitledTest() {
		super("		Shape with component");
		Container c = getContentPane();
		
		JLabel lab = new JLabel("	PlaceBorder(JLabel)	",
				new ImageIcon("middle.gif"), JLabel.LEFT);
		
		PlaceBorderPane pbp = new PlaceBorderPane(new EtchedBorder(), lab, CENTER, TOP);
...
class PlaceBorderPane extends JPanel implements BorderConstants {
	...
	class PlaceBorder extends TitledBorder {
		...
		public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
			Rectangle r = new Rectangle(x + EDGE_SPACING, y + EDGE_SPACING,
